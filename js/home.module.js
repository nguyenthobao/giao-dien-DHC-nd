$(document).ready(function () {
  ...
  console.log(x,y);
                ...
                html_marker += '<div class="div_marker" data-id="' + v.point_id + '" data-lat="' + v.lat + '" data-long="' + v.long + '" style="z-index:7777;margin-top:' + y + 'px; margin-left: ' + (x-75) + 'px;    position: absolute; ">' +
                    '<img src="' + url + '" data-x="' + x + '" data-y="'+y+'" style="z-index:8888;max-width: 20000px; width: 18px;margin-left: 75px; height: 25px" class="point_important img-fluid map" alt="">' +
                    '<br><label data-id="' + v.point_id + '" id="label_' + x + '" class="label_instant">' + v.point_name + '</label><br>' +
                    '<img data-id="' + v.point_id + '" id="img_' + x + '" src="' + pointImage[0] + '" class="img_instant img-fluid map" alt="">' +
                    '</div>';
            });
