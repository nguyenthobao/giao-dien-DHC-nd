    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(pointData, function (k, v) {
                ...
                html_marker += '<div class="div_marker" data-id="' + v.point_id + '" data-lat="' + v.lat + '" data-long="' + v.long + '" style="z-index:' + parseInt(100/k) + ';margin-top:' + y + 'px; margin-left: ' + (x - 75) + 'px;    position: absolute; ">' +
