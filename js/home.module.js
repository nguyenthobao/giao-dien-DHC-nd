     ...
     var scalehammer=$('#scalehammer').val()!=''?$('#scalehammer').val():1;
        ...
        $.each(pointData, function (k, v) {
            ...
            html_marker += '<div class="div_marker" data-id="' + v.point_id + '" data-lat="' + v.lat + '" data-long="' + v.long + '" style="width:'+parseFloat(180/scalehammer)+'px !important;z-index:' + parseInt(100 / (k + 1.1)) + ';margin-top:' + y + 'px; margin-left: ' + (x - 75) + 'px;position: absolute">' +
                ...
                '<br><label style="width:'+parseFloat(180/scalehammer)+'px !important;height:'+parseFloat(120/scalehammer)+'px !important;" data-id="' + v.point_id + '" id="label_' + x + '" class="label_instant" data-lat="' + v.lat + '" data-long="' + v.long + '">' + v.point_name + '</label><br>';
            if (v.point_images != '[]') html_marker += '<img style="margin-top:0" data-id="' + v.point_id + '" id="img_' + x + '"  ' + (pointImage[0] != undefined ? 'src="' + pointImage[0] + '"' : '') + ' class="img_instant img-fluid map" alt="" data-lat="' + v.lat + '" data-long="' + v.long + '">';
            html_marker += '</div>';
        });
